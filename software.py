...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="FACE RECOGNITION BASED ATM",bg="#00fce3",fg="white",font=("arial",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="#00fce3",width=900,height=500)
    ...
    def withdraw_money_page(self):
        ...
        self.label1 =Label(self.frame,text="Note:",bg="#00fce3",fg="white",font=ARIAL)
        self.label2 =Label(self.frame,text="1.By clicking on the 'Verify Face Id' button, we proceed to perform facial recognition.",bg="#00fce3",fg="white",font=ARIAL)
        self.label3 =Label(self.frame,text="2.Each capture will take 15 seconds are you are required to move your face in different directions while being captured.",bg="#00fce3",fg="white",font=ARIAL)
        self.label4 =Label(self.frame,text="3.If your face is recognized, you will be required to input your account password:",bg="#00fce3",fg="white",font=ARIAL)
        self.label5 =Label(self.frame,text="4. If your face is not reconized after 5 seconds, you will automatically be given 2 trial more.",bg="#00fce3",fg="white",font=ARIAL)
        self.label6 =Label(self.frame,text="5.If your face is not recognized after three trials, you wont be allowed to withdraw",bg="#00fce3",fg="white",font=ARIAL)
        self.label7 =Label(self.frame,text="6.To begin, click the 'Verify Face Id' button below",bg="#00fce3",fg="white",font=ARIAL)
    ...
    def enroll_user(self):
        ...
        self.frame = Frame(self.root,bg="#00fce3",width=900,height=500)
        #Login Page Form Components
        self.userlabel =Label(self.frame,text="Full Name",bg="#00fce3",fg="white",font=ARIAL)
        self.uentry = Entry(self.frame,bg="honeydew",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white")
        self.plabel = Label(self.frame, text="Password",bg="#00fce3",fg="white",font=ARIAL)
    ...
    def password_verification(self):
        ...
        #Login Page Form Components
        self.plabel = Label(self.frame, text="Please enter your account password",bg="#00fce3",fg="white",font=ARIAL)
    ...
    def user_account_transfer(self):
        ...
        self.q.place(x=340, y=340, width=120, height=20)
        self.frame.pack()
        self.label11 = Label(self.frame, text="Please enter the reciepient's account number",bg="#00fce3",fg="white",font=ARIAL) 
        self.label21 = Label(self.frame, text="Please enter the amount to be transferred",bg="#00fce3",fg="white",font=ARIAL) 
    ...
    def video_capture_page(self):
        ...
        #Login Page Form Components
        self.label1 =Label(self.frame,text="Note:",bg="#00fce3",fg="white",font=ARIAL)
        self.label2 =Label(self.frame,text="1.By clicking on the 'Capture' button below, your image gets captured ",bg="#00fce3",fg="white",font=ARIAL)
        self.label3 =Label(self.frame,text="2.You will be required to capture 5 images for full registration",bg="#00fce3",fg="white",font=ARIAL)
        self.label4 =Label(self.frame,text="3.To capture each image click the space bar on your keyboard when the camera turn on:",bg="#00fce3",fg="white",font=ARIAL)
        self.label5 =Label(self.frame,text="4. Please wait till you are notified that your capture was successful before leaving the page",bg="#00fce3",fg="white",font=ARIAL)
        data = pd.read_csv('bank_details.csv')
        self.label6 =Label(self.frame,text="5.To begin, click the 'Capture' button below and click the space bar to capture a new image",bg="#00fce3",fg="white",font=ARIAL)
...
root = Tk()
root.title("fACE RECOGNITION BANK")
root.geometry("800x500")
